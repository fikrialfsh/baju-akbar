...
<!-- <div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/hero_1.jpg);" data-aos="fade">
    ...
    <div class="row align-items-start align-items-md-center justify-content-end">
        ...
        <h1 class="mb-2">BELI BAJU DISINI</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Baju terjamin kualitasnya, melalu QC </p>
            <p>
...
<div class="site-section block-3 site-blocks-2 bg-light"  data-aos="fade-up">
    ...
    <div class="row justify-content-center">
        ...
        <h1 class="fashion_taital">Produk Terbaru</h1>
        </div>
    </div>
    <div class="row">
        <div class="col-md-12">
        <div class="nonloop-block-3 owl-carousel" >
            ...
            <div class="block-4 text-center">
                ...
                <img src="{{ url('uploads')}}/{{ $produk->image }}" alt="Image placeholder" class="img-fluid" width="100%" style="height:300px">
                </figure>
                </a>
